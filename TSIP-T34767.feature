@TSIP-T34767 @datemovement
Feature: BPAY Repayment|Commercial Secured Loans - LPT - BPAY Payment
  ...
  Scenario Outline: BPAY Repayment | Commercial Secured Loans - LPT - BPAY Payment 
        Test Cases Involved:
        1) TSIP-T40457:  BPAY Repayment | Commercial Secured Loans - LPT - BPAY Payment 
        Jira:
        1) Ticket: https://racvone.atlassian.net/browse/TSIP-40572

    Given Create A New Loan Using API V2
      | Test Case Name      | TSIP-T34767                |
    ...
    And Fetch the mapping header id for 'Commercial Secured Loans - LPT - BPAY Payment'
