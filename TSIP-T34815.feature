@TSIP-T34815 @datemovement
Feature: BPAY Payment|Consumer Unsecured Loans - RTA - BPAY Payment Reversal
  ...
  Scenario Outline: BPAY Payment | Consumer Unsecured Loans - RTA - BPAY Payment Reversal
        Test Cases Involved:
        1) TSIP-T34815:  BPAY Payment | Consumer Unsecured Loans - RTA - BPAY Payment Reversal
        Jira:
        1) Ticket: https://racvone.atlassian.net/browse/TSIP-40571

    Given Create A New Loan Using API V2
      | Test Case Name      | TSIP-T34815                |
    ...
    And Navigate to Salesforce Login Page
    When Log in as <User>
    And Fetch the dynamic query for mapping header "Consumer Unsecured Loans - RTA - BPAY Payment Reversal"
    ...
    And Fetch the mapping header id for 'Consumer Unsecured Loans - RTA - Direct Credit Payment Reversal'
