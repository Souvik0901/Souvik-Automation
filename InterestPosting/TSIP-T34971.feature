@TSIP-T34971 @datemovement
Feature: Interest Posting | Commercial Secured Loans - IPT - Interest Capitalisation Reversal
  ...
  Scenario Outline: Interest Posting | Commercial Secured Loans - IPT - Interest Capitalisation Reversal
        Test Cases Involved:
