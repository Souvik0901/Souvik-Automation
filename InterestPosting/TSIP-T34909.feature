...
Feature: Interest Posting | Consumer Unsecured Loans - IPT - Interest Capitalisation
  ...
  Scenario Outline: Interest Posting | Consumer Secured Loans - IPT - Interest Capitalisation
        Test Cases Involved:
        1) TSIP-T34909: Interest Posting | Consumer Secured Loans - IPT - Interest Capitalisation
        Jira:
        1) Ticket:

    Given Create A New Loan Using API V2
      | Test Case Name      | TSIP-T34909                |
