@TSIP-T34910 @datemovement
Feature: Interest Posting| Consumer Unsecured Loans - IPT - Interest Capitalisation
  ...
  Scenario Outline: Interest Posting | Consumer Unsecured Loans - IPT - Interest Capitalisation
        Test Cases Involved:
        1) TSIP-T34908: Interest Posting | Consumer Unsecured Loans - IPT - Interest Capitalisation
        Jira:
        1) Ticket:

    Given Create A New Loan Using API V2
      | Test Case Name      | TSIP-T34910                |
      | Loan Test Data Name | Consumer_Unsecured_Weekly  |
    And Open browser
    When Navigate to Salesforce Login Page
    And Log in as Administrator
    When I fetch all Processing DAG records
    ...
    And Fetch the mapping header id for 'Consumer Unsecured Loans - IPT - Interest Capitalisation'
