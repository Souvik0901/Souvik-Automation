@TSIP-T34768 @datemovement
Feature: BPAY Repayment|Consumer Interest Free Loans - LPT - BPAY Payment
  ...
  Scenario Outline: BPAY Repayment | Consumer Interest Free Loans - LPT - BPAY Payment 
        Test Cases Involved:
        1) TSIP-T40457:  BPAY Repayment | Consumer Interest Free Loans - LPT - BPAY Payment 
        Jira:
    ...
    And Fetch the mapping header id for 'Consumer Interest Free Loans - LPT - BPAY Payment'
