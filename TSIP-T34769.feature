@TSIP-T34769 @datemovement
Feature: BPAY Repayment|Consumer Secured Loans - LPT - BPAY Payment
  ...
  Scenario Outline: BPAY Repayment | Consumer Secured Loans - LPT - BPAY Payment 
        Test Cases Involved:
        1) TSIP-T40457:  BPAY Repayment | Consumer Secured Loans - LPT - BPAY Payment 
        Jira:
        1) Ticket: https://racvone.atlassian.net/browse/TSIP-40574

    Given Create A New Loan Using API V2
      | Test Case Name      | TSIP-T34769                |
    ...
    And Fetch the mapping header id for 'Consumer Secured Loans - LPT - BPAY Payment'
