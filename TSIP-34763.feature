@TSIP-T34763 @datemovement
Feature: BPAY Payment|Commercial Secured Loans - RTA - BPAY Payment Reversal
  ...
  Scenario Outline: BPAY Payment | Commercial Secured Loans - RTA - BPAY Payment Reversal
        Test Cases Involved:
        1) TSIP-T34763:  Direct Credit Payment | Commercial Secured Loans - RTA - BPAY Payment Reversal
        Jira:
        1) Ticket: https://racvone.atlassian.net/browse/TSIP-40568

    Given Create A New Loan Using API V2
      | Test Case Name      | TSIP-T34763                |
      | Loan Test Data Name | Commercial_Secured_Monthly |
    And Open browser
    When Navigate to Salesforce Login Page
    And Log in as Administrator
    When I fetch all Processing DAG records
    ...
    And Navigate to Salesforce Login Page
    When Log in as <User>
    And Fetch the dynamic query for mapping header "Commercial Secured Loans - RTA - BPAY Payment Reversal"
    ...
    And Fetch the mapping header id for 'Commercial Secured Loans - RTA - BPAY Payment Reversal'
